              ...
              TextButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      Navigator.pop(context);
                      ToastUtils.positiveToastMessage('Name updated successfully');
                    }
                  },
                  child: const Text(
                    'Save',
            ...
            TextButton(
              onPressed: () {
                ...
                FirebaseFirestore.instance
                  ...
                  ToastUtils.positiveToastMessage('Date of Birth updated successfully');

                  Navigator.pop(context);
                }).catchError((error) {
                  ToastUtils.negativeToastMessage('Failed to update Date of Birth');
                });
              },
              child: const Text(
                'Save',
