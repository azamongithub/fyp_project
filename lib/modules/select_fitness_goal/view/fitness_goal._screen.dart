  ...
  Widget build(BuildContext context) {
    return Consumer2<FitnessGoalController, MyPlansController>(
      builder: (context, controller, plansController, _) {
        return Scaffold(
          appBar: AppBar(
            title: Text(AppStrings.yourFitnessGoal,
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomCard(
                    ...
                    isSelected: controller.selectedFitnessGoal ==
                        AppStrings.muscleBuildingValue,
                    onTap: () {
                      controller.setSelectedFitnessGoal(
                          AppStrings.muscleBuildingValue);
                    },
                  ),
                  CustomCard(
                    ...
                    onTap: () {
                      controller
                          .setSelectedFitnessGoal(AppStrings.weightGainValue);
                    },
                  ),
                  CustomCard(
                    ...
                    onTap: () {
                      controller
                          .setSelectedFitnessGoal(AppStrings.weightLossValue);
                    },
                  ),
                  SizedBox(height: 30.h),
                  CustomButton(
