...
class FitnessController with ChangeNotifier {
  ...
  void _updateWeight(BuildContext context) async {
    ...
    if (newWeight > 24 && newWeight < 500) {
      ...
      ToastUtils.positiveToastMessage('Weight updated successfully');
      Navigator.pop(context);
    } else {
      ToastUtils.negativeToastMessage('Please enter a valid weight.');
    }
  }
  ...
  void _updateHeight(BuildContext context) async {
    ...
    if (newHeight > 50 && newHeight < 280) {
      ...
      ToastUtils.positiveToastMessage('Height updated successfully');

      Navigator.pop(context);
    } else {
      ToastUtils.negativeToastMessage('Please enter a valid height.');
    }
  }
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.pop(context);
                ToastUtils.positiveToastMessage('Fitness Goal updated successfully');
              },
